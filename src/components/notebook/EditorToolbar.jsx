...
import {
  ...
  Code, Quote, Minus, Type, Share2, Mic, Satellite,
} from 'lucide-react'
    ...
    <div className="flex flex-wrap items-center gap-0.5 px-2 py-1.5 border-b border-gray-100 bg-white sticky top-0 z-10 shadow-sm overflow-x-auto">
      ...
      <Group>
        ...
        <div className="relative">
          ...
          {showLinkInput && (
            <div className="absolute top-full left-0 mt-1 p-2 bg-white border border-gray-200 rounded-xl shadow-lifted z-20 flex gap-2 w-52 max-w-[calc(100vw-2rem)]">
...
export function Btn({ onClick, active, disabled, title, children }) {
  return (
    <button onClick={onClick} disabled={disabled} title={title}
      className={`p-2 sm:p-1.5 rounded-lg transition-all text-sm flex-shrink-0 ${
